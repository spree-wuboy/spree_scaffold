...
tinymce.PluginManager.add('responsivefilemanager', function(editor) {
	...
	function openmanager() {
		editor.focus(true);
		var title= tinymce.util.I18n.translate('responsivefilemanager.insertImage');
	...
	editor.addButton('responsivefilemanager', {
		icon: 'browse',
		tooltip: tinymce.util.I18n.translate('responsivefilemanager.insertImage'),
		shortcut: 'Ctrl+E',
                onclick:openmanager
	});
	...
	editor.addMenuItem('responsivefilemanager', {
		icon: 'browse',
		text: tinymce.util.I18n.translate('responsivefilemanager.insertImage'),
		shortcut: 'Ctrl+E',
		onclick: openmanager,
		context: 'insert'
	});
